        ...
        <Card
          ...
          actions={
            <div className="section__actions">
              ...
              <Button button="primary" label={__('Receive')} onClick={() => doOpenModal(MODALS.WALLET_RECEIVE)} />
              <Button button="primary" label={__('Send')} onClick={() => doOpenModal(MODALS.WALLET_SEND)} />
            </div>
          }
        />
        <div>
